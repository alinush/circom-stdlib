...
//
// @notes:
//   For some reason, people implement it like [this](https://github.com/TheFrozenFire/snark-jwt-verify/blob/master/circuits/calculate_total.circom). But this seems really
